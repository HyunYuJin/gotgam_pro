                    ...
                    <b-col sm="12" md="6" class="step-1-1">
                        <b-col md="12">
                            ...
                            <b-row class="my-1">
                                ...
                                <b-col cols="9">
                                    <b-form-input v-model="regist.title" id="input-default" required="required" maxlength="100" placeholder="제목을 입력해주세요..."></b-form-input>
                                </b-col>
                            </b-row>
                            ...
                            <b-row class="mt-2">
                                ...
                                <b-col cols="12">
                                    <b-form-textarea v-model="regist.content" required="required" id="textarea-default" class="gotgamStory" placeholder="회원들과 곶감을 공유해주세요..."></b-form-textarea>
                                </b-col>
                            </b-row>
                    ...
                    <b-col sm="12" md="6" class="step-1-2">
                        <b-col md="12">
                            ...
                            <b-row class="my-3">
                                ...
                                <b-col cols="8">
                                    <b-form-input v-model="regist.dayn" id="input-default" required="required" maxlength="100" placeholder="예시: (3박 4일인 경우 4)"></b-form-input>
                                </b-col>
                                <b-col cols="4">
                                    ...
                                    <b-tab v-for="i in tabs" :key="'dyn-tab-' + i" :title="'DAY ' + i">
                                        ...
                                        <b-col cols="12" class="pt-2">
                                            ...
                                            <b-row>
                                                ...
                                                <!-- day content -->
                                                <b-col cols="12" lg="6">
                                                    <textarea v-model="reg[i].daycontent" class="form-control mb-3 text-xsmall" name="" id="" rows="6" placeholder="이날의 곶감을 기록해주세요."></textarea>
                                                </b-col>
                                            ...
                                            <b-row>
                                                ...
                                                <b-col cols="11" class="form-group form-inline" id="display-location">
                                                    ...
                                                    <textarea v-model="reg[i].daypay" class="form-control col-10 mx-auto" rows="3" name="" id="location"></textarea>
                                                </b-col>
                                            </b-row>
